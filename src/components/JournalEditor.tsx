...
export const JournalEditor: React.FC<JournalEditorProps> = ({
  ...
  return (
    <div className="bg-[#FFFFFF] border border-[#E8E2D7] rounded-2xl p-5 sm:p-6 shadow-xs flex flex-col gap-5">
          ...
          <div className="mt-5 pt-4 border-t border-[#EAE4DC]">
            ...
            >
              {currentBooks.map((book, index) => {
                ...
                let opacity = 1;
                let borderStyle = 'border-[#E0D9CE] bg-[#FFFFFF] shadow-sm';

                if (offset === 1) {
                  zIndex = 20;
                  transform = 'translateY(8px) scale(0.98)';
                  opacity = 0.88;
                  borderStyle = 'border-[#E8E2D7] bg-[#FAF8F5] shadow-xs';
                } else if (offset === 2) {
                  zIndex = 10;
                  transform = 'translateY(16px) scale(0.96)';
                  opacity = 0.72;
                  borderStyle = 'border-[#E8E2D7] bg-[#F8F5F0] shadow-xs';
                } else if (offset > 2) {
                  zIndex = 5;
                  transform = 'translateY(20px) scale(0.92)';
                  opacity = 0;
                  borderStyle = 'border-[#E8E2D7] bg-[#F8F5F0]';
                }
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
                      ...
                      {hasValidCover ? (
                        <div className="w-18 h-26 sm:w-22 sm:h-29 rounded-xl overflow-hidden bg-[#FAF8F5] border border-[#E0D9CE] shadow-xs shrink-0 flex items-center justify-center">
                          <img
                            src={
