    ...
    <div className="relative min-h-[calc(100vh-4rem)] bg-[#FBF9F4] text-[#1F1D1A] py-10 sm:py-16 px-4 sm:px-6 lg:px-8 flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full flex-1 flex flex-col justify-center">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#FFFFFF]/95 backdrop-blur-xs border border-[#E0D8CA] text-[#6B4716] text-xs font-semibold mb-4 shadow-2xs">
            <Sparkles className="w-3.5 h-3.5 text-[#8C5E24]" />
            <span>Welcome, {firstName}</span>
            <span className="text-[#A89884]">•</span>
            <span>Intelligent Thinking Companion</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto w-full mb-12">
          ...
          >
            ...
            <div>
              ...
              <div className="space-y-2 mb-8 pt-4 border-t border-[#EAE4DC]">
                <div className="flex items-center gap-2 text-xs text-[#4D453B] font-medium">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#8C5E24] shrink-0" />
            ...
            {/* Action CTA Button */}
            <div className="flex items-center justify-between pt-4 border-t border-[#EAE4DC] text-sm font-bold text-[#1F1D1A] group-hover:text-[#8C5E24] transition-colors">
              <span>Open Reflection Workspace</span>
              <div className="w-8 h-8 rounded-full bg-[#FAF8F5] group-hover:bg-[#8C5E24] text-[#1F1D1A] group-hover:text-white border border-[#E0D8CA] group-hover:border-[#8C5E24] flex items-center justify-center transition-all">
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="px-3 py-1 rounded-full bg-[#FAF8F5] border border-[#DFCBA8] text-[#6B4716] text-xs font-mono font-semibold">
                  Mode 02
                </span>
              </div>
        ...
        <div className="max-w-4xl mx-auto w-full p-4 sm:p-5 rounded-2xl bg-[#FFFFFF]/95 backdrop-blur-xs border border-[#E0D8CA] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs shadow-2xs">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {recentEntry && (
                <p className="text-[#5C5346] truncate max-w-sm sm:max-w-md font-medium">
            ...
            {entries.length > 0 && (
              <>
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-[#FAF8F5] hover:bg-[#F5EFE6] text-[#423A31] hover:text-[#1F1D1A] font-semibold border border-[#E0D8CA] transition-colors cursor-pointer flex items-center gap-1.5"
                >
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-[#FAF8F5] hover:bg-[#F5EFE6] text-[#423A31] hover:text-[#1F1D1A] font-semibold border border-[#E0D8CA] transition-colors cursor-pointer flex items-center gap-1.5"
                >
                  <Search className="w-3.5 h-3.5 text-[#8C5E24]" />
      ...
      {/* Subtle Footer Note */}
      <div className="relative z-10 max-w-5xl mx-auto w-full mt-8 text-center text-xs text-[#5C5346] font-medium">
